...
logement_patrimoine_page = html.Div(
    children=[
        html.Div(
            className="row",
            children=[
                        ...
                        dbc.Row([
                            ...
                            dbc.Nav(
                                [
                                    ...
                                    dcc.Link(dbc.NavLink("Logement et Patrimoine",active=True),href="/log_patrimoine",refresh=True),
